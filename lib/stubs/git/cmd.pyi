...
class Git(LazyMixin):
    ...
    def execute(
        ...
        istream: IO[Any] = ...,
        with_extended_output: Literal[True] = True,
        with_exceptions: bool = ...,
        as_process: bool = ...,
        output_stream: Optional[IO[Any]] = ...,
        stdout_as_string: bool = ...,
        kill_after_timeout: Optional[int] = ...,
        with_stdout: bool = ...,
