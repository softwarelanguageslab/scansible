...
class GitConfigParser:
    ...
    def __init__(
        self,
        file_or_files: Union[Sequence[_Path], _Path, None] = ...,
        read_only: bool = ...,
        merge_includes: bool = ...,
        config_level: Optional[_ConfigLevel] = ...,
    ) -> None: ...
    def __del__(self) -> None: ...
    ...
    @overload
    def get_value(
        self, section: str, option: str, default: _D = ...
    ) -> Union[str, int, float, _D]: ...
    @overload
    def get_value(self, section: str, option: str) -> Union[str, int, float]: ...  # type: ignore[misc]
    @overload
    def get_values(
        self, section: str, option: str, default: _D = ...
    ) -> List[Union[str, int, float, _D]]: ...
    @overload
