...
class SymbolicReference:
    ...
    @commit.setter
    def commit(
        self, commit: Union[str, Commit, SymbolicReference]
    ) -> SymbolicReference: ...
    def set_commit(
        self, commit: Union[str, Commit, SymbolicReference], logmsg: Optional[str] = ...
    ) -> SymbolicReference: ...
    @property
    def object(self) -> Object: ...
    @object.setter
    def object(
        self, object: Union[str, Object, SymbolicReference], logmsg: Optional[str] = ...
    ) -> SymbolicReference: ...
    def set_object(
        self, object: Union[str, Object, SymbolicReference]
    ) -> SymbolicReference: ...
    @property
    def reference(self) -> SymbolicReference: ...
    @reference.setter
    def reference(
        self, ref: Union[str, Object, SymbolicReference], logmsg: Optional[str] = ...
    ) -> SymbolicReference: ...
    def set_reference(
        self, ref: Union[str, Object, SymbolicReference]
    ) -> SymbolicReference: ...
    ...
    def log(self) -> RefLog: ...
    def log_append(
        self, oldbinsha: bytes, message: str, newbinsha: Optional[bytes] = ...
    ) -> RefLogEntry: ...
    ...
    def rename(
        self, new_path: Union[SymbolicReference, str], force: bool = ...
    ) -> SymbolicReference: ...
    @classmethod
    def iter_items(
        cls, repo: Repo, common_path: Optional[str] = ...
    ) -> Iterator[SymbolicReference]: ...
    @classmethod
