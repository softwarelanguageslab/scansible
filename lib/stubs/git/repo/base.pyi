...
from typing import Any, Iterator, Literal, Optional, Pattern, Tuple, Type, Union
...
class Repo:
    ...
    def iter_commits(
        self, rev: Optional[str] = ..., paths: str = ..., **kwargs: Any
    ) -> Iterator[Commit]: ...
    ...
    def blame(
        self, rev: Any, file: Any, incremental: bool = ..., **kwargs: Any
    ) -> Any: ...
    @classmethod
    def init(
        cls,
    ...
    def clone(
        self,
        path: _Path,
        progress: Optional[RemoteProgress] = ...,
        multi_options: Optional[Any] = ...,
        **kwargs: Any,
    ) -> Repo: ...
    @classmethod
    def clone_from(
