...
class Dot(files.File):
    ...
    @overload
    def subgraph(self: _Self, name: Optional[str] = ..., comment: Optional[str] = ..., graph_attr: Optional[Attrs] = ..., node_attr: Optional[Attrs] = ..., edge_attr: Optional[Attrs] = ..., body: Optional[Iterable[str]] = ...) -> SubgraphContext[_Self]: ...
