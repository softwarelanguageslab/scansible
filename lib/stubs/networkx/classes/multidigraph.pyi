...
class MultiDiGraph(MultiGraph[NodeT, GraphAttrT, EdgeAttrT], DiGraph[NodeT, GraphAttrT, EdgeAttrT]):
    ...
    @overload
    def edges(self, *, data: Literal[True], keys: Literal[True]) -> Sequence[tuple[NodeT, NodeT, int, Mapping[str, EdgeAttrT]]]: ...
    # TODO: More overloads
    # def out_edges(self): ...
    def in_edges(self, node: NodeT, data: str) -> Sequence[tuple[NodeT, NodeT, EdgeAttrT]]: ...
    # def degree(self): ...
    # def in_degree(self): ...
    # def out_degree(self): ...
