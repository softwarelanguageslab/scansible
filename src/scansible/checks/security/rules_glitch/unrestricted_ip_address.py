...
class UnrestrictedIPAddressRule(Rule):
    ...
    def create_unrestricted_ip_address_check(self, value_accessor: str, type_accessor: str) -> str:
        return self._create_string_contains_test(self.BAD_IPS, value_accessor, type_accessor)
