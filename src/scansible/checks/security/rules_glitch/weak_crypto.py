...
class WeakCryptoAlgorithmRule(Rule):
    ...
    def create_whitelist_test(self, value_accessor: str, type_accessor: str = '') -> str:
        return self._create_string_contains_test(self.WEAK_CRYPTO_WHITELIST, value_accessor, type_accessor)
    ...
    def _create_query(self, source_type: str, value_prop: str, type_prop: str = '') -> str:
        ...
        return f'''
            ...
            WHERE {self.create_bad_algo_test(value_accessor, type_accessor)}
                AND NOT ({self.create_whitelist_test("check_arg.keyword")})
