...
def describe_unmodified() -> None:
            ...
            create_graph(
                {
                    ...
                    "expr": Expression(
                        expr="hello {{ _1 }}", orig_expr="hello {{ target }}"
                    ),
            ...
            create_graph(
                {
                    ...
                    "expr": Expression(
                        expr="hello {{ _1 }}", orig_expr="hello {{ ansible_version }}"
                    ),
                    "iv": IntermediateValue(identifier=0),
                },
                [
            ...
            create_graph(
                {
                    ...
                    "expr": Expression(
                        expr="hello {{ _1 }}", orig_expr="hello {{ ansible_os_family }}"
                    ),
                    "iv": IntermediateValue(identifier=0),
                },
                [
            ...
            create_graph(
                {
                    ...
                    "e2": Expression(expr="{{ _1 }}", orig_expr="{{ msg }}"),
    ...
    def should_not_reevaluate_static_templates(
        ...
        assert_graphs_match(
            ...
            create_graph(
                {
                    "e": Expression(expr=expected, orig_expr=expr),
                    "iv": IntermediateValue(identifier=1),
                },
                [("e", "iv", DEF)],
            ),
    ...
    def should_reevaluate_dynamic_templates(
        ...
        assert_graphs_match(
            ...
            create_graph(
                {
                    "e": Expression(
                        expr=expected, orig_expr=expr, impure_components=components
                    ),
                    "iv1": IntermediateValue(identifier=1),
                    "iv2": IntermediateValue(identifier=2),
                },
            ...
            create_graph(
                {
                    ...
                    "e1": Expression(expr="{{ _1 }} world", orig_expr="{{ a }} world"),
                    "a2": Variable(
                        name="a",
                        version=1,
                        value_version=0,
                    ...
                    "e2": Expression(expr="{{ _1 }} world", orig_expr="{{ a }} world"),
                    "iv1": IntermediateValue(identifier=1),
                    "iv2": IntermediateValue(identifier=2),
                },
                [
            ...
            create_graph(
                {
                    ...
                    "e2": Expression(expr="{{ _1 }}!", orig_expr="{{ b }}!"),
                    ...
                    "e3": Expression(expr="{{ _1 }} world", orig_expr="{{ a }} world"),
                    "i3": IntermediateValue(identifier=3),
                    "e4": Expression(expr="{{ _1 }}!", orig_expr="{{ b }}!"),
            ...
            create_graph(
                {
                    ...
                    "e1": Expression(expr="1 {{ _1 }}", orig_expr="1 {{ a }}"),
                    "iv1": IntermediateValue(identifier=1),
                    "ainner": Variable(
                        name="a",
                        version=1,
                    ...
                    "e2": Expression(expr="2 {{ _1 }}", orig_expr="2 {{ a }}"),
                    "iv2": IntermediateValue(identifier=2),
                },
                [
                    ("1", "aouter", DEF),
            ...
            create_graph(
                {
                    ...
                    "2": ScalarLiteral(type="str", value="2"),
                    "e": Expression(expr="{{ _1 }}", orig_expr="{{ a }}"),
                    "iv": IntermediateValue(identifier=1),
                },
                [
                    ("1", "aouter", DEF),
            ...
            create_graph(
                {
                    ...
                    "e": Expression(expr="{{ _1 }}", orig_expr="{{ ansible_version }}"),
                    "iv": IntermediateValue(identifier=1),
                },
                [
                    ("l123", "unused", DEF),
            ...
            create_graph(
                {
                    ...
                    "e1": Expression(
                        expr="1: {{ _1 }}", orig_expr="1: {{ ansible_version }}"
                    ),
                    "e2": Expression(
                        expr="2: {{ _1 }}", orig_expr="2: {{ ansible_version }}"
                    ),
                    "iv1": IntermediateValue(identifier=1),
                    "iv2": IntermediateValue(identifier=2),
                },
            ...
            create_graph(
                {
                    ...
                    "e": Expression(
                        expr="{{ _1 }}", orig_expr="{{ ansible_os_family }}"
                    ),
                    "iv": IntermediateValue(identifier=1),
                },
                [
            ...
            create_graph(
                {
                    ...
                    "e_host_fact": Expression(
                        expr="{{ _1 }}", orig_expr="{{ ansible_os_family }}"
                    ),
                    "e_role_var": Expression(
                        expr="{{ _1 }}", orig_expr="{{ ansible_os_family }}"
                    ),
            ...
            create_graph(
                {
                    ...
                    "e1": Expression(
                        expr="1: {{ _1 }}", orig_expr="1: {{ ansible_os_family }}"
                    ),
                    "e2": Expression(
                        expr="2: {{ _1 }}", orig_expr="2: {{ ansible_os_family }}"
                    ),
                    "iv1": IntermediateValue(identifier=1),
                    "iv2": IntermediateValue(identifier=2),
                },
            ...
            create_graph(
                {
                    ...
                    "2": ScalarLiteral(type="str", value="2"),
                    "e2": Expression(expr="1 {{ _1 }}", orig_expr="1 {{ a }}"),
                    "iv2": IntermediateValue(identifier=2),
                },
                [
                    ("1", "aouter", DEF),
            ...
            create_graph(
                {
                    ...
                    "aei": Expression(expr="{{ _1 }}", orig_expr="{{ b }}"),
                    ...
                    "ei": Expression(expr="{{ _1 }}", orig_expr="{{ a }}"),
                    ...
                    "eo": Expression(expr="{{ _1 }}", orig_expr="{{ a }}"),
                    ...
                    "aeo": Expression(expr="{{ _1 }}", orig_expr="{{ b }}"),
            ...
            create_graph(
                {
                    ...
                    "bie": Expression(
                        expr="{{ _1 | reverse }}", orig_expr="{{ c | reverse }}"
                    ),
            ...
            create_graph(
                {
                    ...
                    "ae": Expression(expr="{{ _1 }}", orig_expr="{{ b }}"),
                    "aei": IntermediateValue(identifier=0),
                    "te": Expression(expr="{{ _1 }}", orig_expr="{{ a }}"),
            ...
            create_graph(
                {
                    ...
                    "be": Expression(expr="{{ _1 }}", orig_expr="{{ b }}"),
            ...
            create_graph(
                {
                    ...
                    "e1": Expression(expr="{{ _1 + 1 }}", orig_expr="{{ b + 1 }}"),
                    "e2": Expression(expr="{{ _1 + 2 }}", orig_expr="{{ b + 2 }}"),
