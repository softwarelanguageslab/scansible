...
from scansible.representations.pdg import Graph, DEF, Keyword, ORDER, USE, Expression, Literal, Node, Task, Variable, NodeLocation
...
def describe_dump_node() -> None:
    ...
    def should_dump_literal_non_string(g: Graph, type: LiteralT['int', 'float', 'bool'], value: int | float | bool) -> None:
