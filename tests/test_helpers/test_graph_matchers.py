...
from scansible.representations.pdg import Graph, Expression, IntermediateValue, Task, Variable, DEF, USE, ORDER, ORDER_TRANS
...
def describe_create_graph() -> None:
    ...
    def should_create_graph_with_nodes() -> None:
        ...
        g2 = Graph(role_name='test_role', role_version='test_version')
        g2.add_nodes_from([Variable(name='a', version=1, value_version=1, scope_level=1), Variable(name='b', version=1, value_version=1, scope_level=1)])
